...
<h5 class="card-title text-white">Google Maps</h5>
</div>
<div class="card-body">
...
{{-- javascript code --}}
<script src="https://maps.google.com/maps/api/js?key=AIzaSyCZRnWIiyl75eg_0mAoo1YvXMVRVQ3aVIQ&libraries=places&callback=initAutocomplete" type="text/javascript"></script>
<script>
